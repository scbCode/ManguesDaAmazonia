...
class _MapBlack extends State<MapBlack> with SingleTickerProviderStateMixin {
  ...
  bool form_black_v=false;
  int mapaSelect_black=0;
  bool acerto = false;
  bool erro = false;
              ...
              Column(children: [
                ...
                GestureDetector(
                    ...
                    Colors.black12 : Colors.white,
                        boxShadow: [BoxShadow(color:Colors.black54)],
                        borderRadius: BorderRadius.circular(20)),
                      child: Text( form_black[mapaSelect_black][0],style: TextStyle(color:Colors.black,fontSize: 16,fontFamily: 'MochiyPopPOne'),),)),
                ...
                GestureDetector(
                    ...
                    Container(            width: MediaQuery.of(context).size.width*.25,
                      ...
                      Colors.black12 : Colors.white,
                          boxShadow: [BoxShadow(color:Colors.black54)],
                          borderRadius: BorderRadius.circular(20)),
                      child: Text( form_black[mapaSelect_black][1]
                        ,style: TextStyle(color:Colors.black,fontSize: 16,fontFamily: 'MochiyPopPOne'),),)),
                ...
                GestureDetector(
                    ...
                    Colors.black12 : Colors.white,
                        boxShadow: [BoxShadow(color:Colors.black54)],
                        borderRadius: BorderRadius.circular(20)),
                      child: Text( form_black[mapaSelect_black][2],style: TextStyle(color:Colors.black,fontSize: 16,fontFamily: 'MochiyPopPOne'),),)),
                ...
                GestureDetector(
                    ...
                    Container(            width: MediaQuery.of(context).size.width*.25,
                      ...
                      padding: EdgeInsets.all(15), decoration: BoxDecoration(color:resp_jogada==3 ? Colors.black12 : Colors.white,
                          boxShadow: [BoxShadow(color:Colors.black54)],
                          borderRadius: BorderRadius.circular(20)),
                      child: Text( form_black[mapaSelect_black][3],style: TextStyle(color:Colors.black,fontSize: 16,fontFamily: 'MochiyPopPOne'),),)),
                ...
                GestureDetector(
                    ...
                    Container(            width: MediaQuery.of(context).size.width*.25,
                      ...
                      padding: EdgeInsets.all(15), decoration: BoxDecoration(color:resp_jogada==4 ?  Colors.black12 : Colors.white,
                          boxShadow: [BoxShadow(color:Colors.black54)],
                          borderRadius: BorderRadius.circular(20)),
                      child: Text( form_black[mapaSelect_black][4],style: TextStyle(color:Colors.black,fontSize: 16,fontFamily: 'MochiyPopPOne'),),)),
